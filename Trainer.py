...
class Optimizer_SGD:
    # Initialise optimizer - set settings,
...
os.chdir(r"C:\Users\JackCarter\OneDrive - PVP Flooring\Desktop\01")
...
try:
    for a in range(100000):
        print(f"Learning: {a}, Score: {lowest_score}, Accuracy: {accuracy*100:.2f}%", end="\r", flush=True)
        dense1.forward(X)
        a1.forward(dense1.output)
        dense2.forward(a1.output)
...
if save:
    ...
    with open('Model/Number_Recognition_Model.json', 'w') as file:
