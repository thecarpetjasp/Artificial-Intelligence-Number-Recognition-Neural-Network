...
This model is not anything groundbreaking in the world of Artificial Intelligence. But, I hope this could serve someone well, who might be looking for some insights in to how neural networks can be built from scratch without using pre-built models from packages such as PyTorch or Tensorflow.
